...
<head>
    ...
    <!-- favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="./SOURCE/sun.png">
    <link rel="icon" type="image/png" sizes="32x32" href="./SOURCE/sun.png">
    <link rel="icon" type="image/png" sizes="16x16" href="./SOURCE/sun.png">
