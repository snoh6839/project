...
// POST 일 때
    ...
    $arr_info =
        array(
            "task_date"    => $arr_post["task_date"], "start_time"    => $arr_post["start_time"], "end_time"    => $arr_post["end_time"], "task_title"    => $arr_post["task_title"], "is_com"        => $arr_post["is_com"], "task_memo"    => $arr_post["task_memo"], "category_no"    => $arr_post["category_no"]
        );
